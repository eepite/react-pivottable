...
export default function createPlotlyRenderers(PlotlyComponent) {
  return {
    'Gráfico de Columnas Agrupadas': makeRenderer(
      PlotlyComponent,
      {type: 'bar'},
      {barmode: 'group'}
    ),
    'Gráfico de Columnas Apiladas': makeRenderer(
      PlotlyComponent,
      {type: 'bar'},
      {barmode: 'relative'}
    ),
    ...
    'Gráfico de Barras Apiladas': makeRenderer(
      PlotlyComponent,
      {type: 'bar', orientation: 'h'},
      {barmode: 'relative'},
      true
    ...
    'Gráfico de Puntos': makeRenderer(
      PlotlyComponent,
      {mode: 'markers'},
      {},
      true
    ...
    'Gráfico de Múltiples Pasteles': makeRenderer(
      PlotlyComponent,
